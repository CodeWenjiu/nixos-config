...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/891c2334-4d6e-49c9-b008-c886edb1ff25";
      fsType = "ext4";
    };
  ...
  swapDevices =
    [ { device = "/dev/disk/by-uuid/b1b86e08-7abd-47c1-af0a-94d6d8276d5c"; }
    ];
  ...
  # networking.interfaces.eth4.useDHCP = lib.mkDefault true;
